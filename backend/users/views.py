    ...
    def post(self, request):
        ...
        if user:
            ...
            return Response({
                ...
                "refresh": str(refresh),
                "email": user.email,
                "rol": getattr(user, "rol", ""),  # si tu modelo tiene 'rol'
...
# -----------------------
# Listar usuarios (para el panel de configuración)
# -----------------------
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            try:
                ...
                pass  # Para no revelar si el correo existe
...
# -----------------------
# Rutas (para tu archivo users/urls.py)
# -----------------------
